...
---1 : Une procédure qui Ajoute   un warehouse  à une location donnée ---
DECLARE
...
--2 : Une procédure qui met à jour les donnees   d'un warehouse   ---
...
--3 : Une procédure qui supprime  un warehouse  ---
...
--4  Une procédure qui affiche  les warehouses d'une location donnée  ---
DECLARE 
...
--5  Une procédure qui calcule le CA d'un employé  ---
...
--1 -- Fonction qui retourne le prix total d'une commande 
DECLARE 
...
--2 -- Fonction qui retourne le nombre de commande qui ont le status "PENDING" 
...
--------------------------------------------------------- Partie Déclencheurs -------------------------------------------------------------------
--1 --  un déclencheur qui affiche le résumé d’une commande
...
--2 --  un déclencheur qui  affiche une alerte du stocke une fois le nombre d’article disponible en inventaire est < 10
...
--4 -- un déclencheur qui  interdit l’ajout d’un employé si HIRE_DATE est > a Date d’aujourd’hui
...
--=5 -- un déclencheur qui applique une remise de 5% si le prix total de la commande est > 10000$
